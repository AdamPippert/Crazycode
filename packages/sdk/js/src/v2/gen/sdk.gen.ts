...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new CrazycodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the CrazyCode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the CrazyCode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all CrazyCode instances, releasing all resources.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with CrazyCode.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that CrazyCode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by CrazyCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current CrazyCode configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update CrazyCode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current CrazyCode instance, releasing all resources.
   */
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all CrazyCode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific CrazyCode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the CrazyCode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the CrazyCode system.
   */
...
export class CrazycodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<CrazycodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    CrazycodeClient.__registry.set(this, args?.key)
  }
