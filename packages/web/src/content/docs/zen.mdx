---
title: Zen
description: Curated list of models provided by CrazyCode.
---
...
CrazyCode Zen is a list of tested and verified models provided by the CrazyCode team.

:::note
CrazyCode Zen is currently in beta.
:::

Zen works like any other provider in CrazyCode. You login to CrazyCode Zen and get
...
:::tip
We tested a select group of models and providers that work well with CrazyCode.
:::
...
CrazyCode Zen is an AI gateway that gives you access to these models.

---

## How it works

CrazyCode Zen works like any other provider in CrazyCode.

1. You sign in to **<a href={console}>CrazyCode Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select CrazyCode Zen, and paste your API key.
...
| ------------------ | ------------------ | --------------------------------------------------- | --------------------------- |
| GPT 5.2            | gpt-5.2            | `https://crazycode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1            | gpt-5.1            | `https://crazycode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex      | gpt-5.1-codex      | `https://crazycode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max  | gpt-5.1-codex-max  | `https://crazycode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini | gpt-5.1-codex-mini | `https://crazycode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5              | gpt-5              | `https://crazycode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Codex        | gpt-5-codex        | `https://crazycode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Nano         | gpt-5-nano         | `https://crazycode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| Claude Sonnet 4.5  | claude-sonnet-4-5  | `https://crazycode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4    | claude-sonnet-4    | `https://crazycode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5   | claude-haiku-4-5   | `https://crazycode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5   | claude-3-5-haiku   | `https://crazycode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5    | claude-opus-4-5    | `https://crazycode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1    | claude-opus-4-1    | `https://crazycode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| MiniMax M2.1       | minimax-m2.1-free  | `https://crazycode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3 Pro       | gemini-3-pro       | `https://crazycode.ai/zen/v1/models/gemini-3-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash     | gemini-3-flash     | `https://crazycode.ai/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| GLM 4.6            | glm-4.6            | `https://crazycode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7            | glm-4.7-free       | `https://crazycode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2            | kimi-k2            | `https://crazycode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Thinking   | kimi-k2-thinking   | `https://crazycode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3 Coder 480B   | qwen3-coder        | `https://crazycode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Grok Code Fast 1   | grok-code          | `https://crazycode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle         | big-pickle         | `https://crazycode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

The [model id](/docs/config/#models) in your CrazyCode config
uses the format `crazycode/<model-id>`. For example, for GPT 5.1 Codex, you would
use `crazycode/gpt-5.1-codex` in your config.
...
```
https://crazycode.ai/zen/v1/models
```
...
- Grok Code Fast 1 is currently free on CrazyCode for a limited time. The xAI team is using this time to collect feedback and improve Grok Code.
- GLM 4.7 is currently free on CrazyCode for a limited time. The team is using this time to collect feedback and improve the model.
- MiniMax M2.1 is currently free on CrazyCode for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on CrazyCode for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with CrazyCode as well.
