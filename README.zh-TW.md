...
brew install AdamPippert/tap/crazycode # macOS 與 Linux（推薦，始終保持最新）
brew install crazycode              # macOS 與 Linux（官方 brew formula，更新頻率較低）
paru -S crazycode-bin               # Arch Linux
mise use -g github:AdamPippert/Crazycode    # 任何作業系統
nix run nixpkgs#crazycode           # 或使用 github:AdamPippert/Crazycode 以取得最新開發分支
```
