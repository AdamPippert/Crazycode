...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/AdamPippert/Crazycode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for AdamPippert/Crazycode...\n")
...
console.log("Fetching npm all-time downloads for crazycode-ai...\n")
const npmDownloads = await fetchNpmDownloads("crazycode-ai")
