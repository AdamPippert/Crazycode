...
npm i -g crazycode-ai@latest        # o bun/pnpm/yarn
...
nix run nixpkgs#opencode           # o github:AdamPippert/Crazycode para la rama dev más reciente
```
...
CrazyCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/AdamPippert/Crazycode/releases) o desde [crazycode.ai/download](https://crazycode.ai/download).
...
CrazyCode incluye dos agents integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agents](https://crazycode.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar CrazyCode, [**ve a nuestra documentación**](https://crazycode.ai/docs).

### Contribuir

Si te interesa contribuir a CrazyCode, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Construyendo sobre CrazyCode

Si estás trabajando en un proyecto relacionado con CrazyCode y usas "opencode" como parte del nombre; por ejemplo, "opencode-dashboard" u "opencode-mobile", agrega una nota en tu README para aclarar que no está construido por el equipo de CrazyCode y que no está afiliado con nosotros de ninguna manera.
...
- 100% open source
- No está acoplado a ningún proveedor. Aunque recomendamos los modelos que ofrecemos a través de [CrazyCode Zen](https://crazycode.ai/zen); CrazyCode se puede usar con Claude, OpenAI, Google o incluso modelos locales. A medida que evolucionan los modelos, las brechas se cerrarán y los precios bajarán, por lo que ser agnóstico al proveedor es importante.
- Soporte LSP listo para usar
- Un enfoque en la TUI. CrazyCode está construido por usuarios de neovim y los creadores de [terminal.shop](https://terminal.shop); vamos a empujar los límites de lo que es posible en la terminal.
- Arquitectura cliente/servidor. Esto, por ejemplo, permite ejecutar CrazyCode en tu computadora mientras lo controlas de forma remota desde una app móvil. Esto significa que el frontend TUI es solo uno de los posibles clientes.
