...
# Package manager
npm i -g crazycode-ai@latest        # oppure bun/pnpm/yarn
...
nix run nixpkgs#opencode           # oppure github:AdamPippert/Crazycode per l’ultima branch di sviluppo
```
...
CrazyCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/AdamPippert/Crazycode/releases) oppure da [crazycode.ai/download](https://crazycode.ai/download).
...
CrazyCode include due agenti integrati tra cui puoi passare usando il tasto `Tab`.
...
Scopri di più sugli [agenti](https://crazycode.ai/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare CrazyCode, [**consulta la nostra documentazione**](https://crazycode.ai/docs).

### Contribuire

Se sei interessato a contribuire a CrazyCode, leggi la nostra [guida alla contribuzione](./CONTRIBUTING.md) prima di inviare una pull request.

### Costruire su CrazyCode

Se stai lavorando a un progetto correlato a CrazyCode e che utilizza “opencode” come parte del nome (ad esempio “opencode-dashboard” o “opencode-mobile”), aggiungi una nota nel tuo README per chiarire che non è sviluppato dal team CrazyCode e che non è affiliato in alcun modo con noi.
...
- 100% open source
- Non è legato a nessun provider. Anche se consigliamo i modelli forniti tramite [CrazyCode Zen](https://crazycode.ai/zen), CrazyCode può essere utilizzato con Claude, OpenAI, Google o persino modelli locali. Con l’evoluzione dei modelli, le differenze tra di essi si ridurranno e i prezzi scenderanno, quindi essere indipendenti dal provider è importante.
- Supporto LSP pronto all’uso
- Forte attenzione alla TUI. CrazyCode è sviluppato da utenti neovim e dai creatori di [terminal.shop](https://terminal.shop); spingeremo al limite ciò che è possibile fare nel terminale.
- Architettura client/server. Questo, ad esempio, permette a CrazyCode di girare sul tuo computer mentre lo controlli da remoto tramite un’app mobile. La frontend TUI è quindi solo uno dei possibili client.
